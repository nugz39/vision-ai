...
const ITEMS: GalleryItem[] = [
  { id: "img-01", title: "Editorial Still",       caption: "Premium mainstream styling (brand-safe).", src: "/assets/gallery/prompt-01.png", mode: "image", style: "editorial" },
  ...
  { id: "img-04", title: "UI Mockup Look",        caption: "Modern interface / product visuals.",    src: "/assets/gallery/prompt-04.png", mode: "image", style: "product" },

  { id: "vid-01", title: "Cinematic Keyframe",    caption: "Storyboard-ready shot direction.",       src: "/assets/gallery/prompt-05.png", mode: "video", style: "cinematic" },
  { id: "vid-02", title: "Abstract Motion Plate", caption: "Premium abstract energy plate.",         src: "/assets/gallery/prompt-06.png", mode: "video", style: "abstract" },
  { id: "vid-03", title: "Soft Neon Scene",       caption: "Commercial-grade lighting & grade.",     src: "/assets/gallery/prompt-07.png", mode: "video", style: "neon" },
  { id: "vid-04", title: "Minimal Sequence",      caption: "Clean motion-friendly composition.",     src: "/assets/gallery/prompt-08.png", mode: "video", style: "minimal" },
  ...
  { id: "rmx-02", title: "Neon Grade Remix",      caption: "Same subject, fresher lighting.",        src: "/assets/gallery/prompt-10.png", mode: "remix", style: "neon" },
  { id: "rmx-03", title: "Cinematic Pass",        caption: "Film-like rolloff & contrast.",          src: "/assets/gallery/prompt-11.png", mode: "remix", style: "cinematic" },
  { id: "rmx-04", title: "Editorial Regrade",     caption: "Sharper whites + premium finish.",       src: "/assets/gallery/prompt-12.png", mode: "remix", style: "editorial" },
];
...
export function styleFromSlug(slug: string): AnyStyle {
  ...
  if (s === "3d" || s === "three-d" || s === "three-dim" || s === "3-d") return "3d";
...
export function getItemsFor(mode: GalleryMode, style: AnyStyle = "all"): GalleryItem[] {
  ...
  if (style === "all") return base;
  return base.filter(i => i.style === style);
}
